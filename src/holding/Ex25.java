package holding;// holding/Ex25.java
// TIJ4 Chapter Holding, Exercise 25, page 423
/* Create a Map<String, ArrayList<Coffee>>. Use net.mindview.TextFile
...
* ArrayList<Coffee> the word count associated with that word - that is,
...
public class Ex25 {
    public static void main(String[] args) {
        ...
        words.addAll(new TextFile("E:\\My_code\\Java\\ThinkInJava\\src\\holding\\Ex25.java", "\\W+"));
