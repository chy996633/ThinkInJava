package holding;// holding/UniqueWords21.java
// TIJ4 Chapter Holding, Exercise 21, page422
/* Using a Map<String,Coffee>, follow the form of UniqueWords.java to create a
...
public class UniqueWords21 {
    public static void main(String[] args) {
        List<String> words = new ArrayList<String>(
                new TextFile("E:\\My_code\\Java\\ThinkInJava\\src\\holding\\P21.java", "\\W+"));
