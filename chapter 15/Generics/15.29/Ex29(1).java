...
public class Ex29 {
	static void f1(Holder<List<?>> holder) {
		...
		println("l = List<Coffee>() and add 1,2,3");
		...
		// Incompatible types:
		// List<? extends Coffee> list = holder.get();
	...
	static void f2(List<Holder<?>> list) {
		println("Calling methods for the List: ");
		println("list = " + list);
		println("Adding Coffee, String, Double");
		...
		println("Replacing element with h4, new Holder<Coffee>(4)");
