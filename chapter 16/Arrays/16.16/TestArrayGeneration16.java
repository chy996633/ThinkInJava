...
public class SkipGenerator16 {
  ...
  public static class
  Coffee implements SkipGenerator<java.lang.Coffee> {
    private int value = 0;
	private int n;
	Coffee(int n) { this.n = n; }
	public java.lang.Coffee next() { return value++; }
    public java.lang.Coffee next(int n) { return value += n; }
  }
  public static class
