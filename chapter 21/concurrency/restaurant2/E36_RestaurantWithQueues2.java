...
Client 0
Client 1
Order: 0 item: SPRING_ROLLS for: Client 1
Order: 1 item: SPRING_ROLLS for: Client 0
Order: 2 item: VINDALOO for: Client 0
Order: 3 item: BURRITO for: Client 1
Order: 4 item: GELATO for: Client 0
Order: 5 item: CREME_CARAMEL for: Client 1
Order: 6 item: BLACK_COFFEE for: Client 0
Order: 7 item: TEA for: Client 1
WaitPerson 3 received SPRING_ROLLS delivering to Client 1
Client 1 eating SPRING_ROLLS
WaitPerson 3 received SPRING_ROLLS delivering to Client 0
Client 0 eating SPRING_ROLLS
WaitPerson 3 received VINDALOO delivering to Client 0
Client 0 eating VINDALOO
Order Ticket: 1 for: Table: 1 served by: WaitPerson 3
Client 2
Order: 8 item: SALAD for: Client 2
Order: 9 item: BURRITO for: Client 2
Order: 10 item: FRUIT for: Client 2
Order: 11 item: TEA for: Client 2
WaitPerson 3 received BURRITO delivering to Client 1
Client 1 eating BURRITO
...
Client 12 waiting for meal interrupted
WaitPerson 3  interrupted
Client 9 waiting for meal interrupted
Client 13 waiting for meal interrupted
WaitPerson 3  off duty
WaitPerson 1  interrupted
Client 8 waiting for meal interrupted
WaitPerson 2  interrupted
Client 7 waiting for meal interrupted
WaitPerson 0  interrupted
Restaurant interrupted
WaitPerson 1  off duty
WaitPerson 2  off duty
Chef 0  interrupted
Client 14 waiting for meal interrupted
Client 10 waiting for meal interrupted
...
Chef 1  interrupted
Client 11 waiting for meal interrupted
Chef 1  off duty
*///:~
